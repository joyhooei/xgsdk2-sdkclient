...
public abstract class XGChannel {
	...
	static {
		METHODS_MAP.put("login", new Class[] { Activity.class, String.class });
		METHODS_MAP.put("logout", new Class[] { Activity.class, String.class });
		METHODS_MAP.put("pay", new Class[] { Activity.class, PayInfo.class,
				PayCallBack.class });
		METHODS_MAP.put("switchAccount", new Class[] { Activity.class,
				String.class });
		METHODS_MAP.put("openUserCenter", new Class[] { Activity.class,
				String.class });
		METHODS_MAP.put("exit", new Class[] { Activity.class,
				ExitCallBack.class, String.class });
	}
}
