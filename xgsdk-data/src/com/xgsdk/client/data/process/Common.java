...
import com.xgsdk.client.data.utils.JSONTools;
...
public class Common {
    ...
    public static void sendCountEvent(Context context) {
        try {
            ...
            XGLog.e("sendCountEvent error", e);
        }
    }
    ...
    public static void storeCountEvent(Context context) {
        try {
            ...
            XGLog.e("JSONException in storeCountEvent ", e);
        }
    }
    ...
    private static String getDataType(JSONObject actionJSONObject) {
        ...
        try {
            ...
            XGLog.e("getDataType error: " + actionJSONObject, e);
        }
        return dataType;
    }
    ...
    public static void postToServer(Context context, JSONObject actionJson) {
        if (actionJson == null) {
            XGLog.i("postToServer actionJson is null");
            return;
        }

        if (context == null) {
            XGLog.i("postToServer context cannot be null");
            return;
        }
        ...
        try {
            ...
            if (!isLaunch && !isTerminate) {
                ...
                while (times < SEND_TRY_TIMES && isFail) {
                    ...
                    if (isFail) {
                        XGLog.w("try " + times + " times. send " + action
    ...
    public static void writeToCachedFile(Context context,
        ...
        try {
            ...
            XGLog.d("write to cache " + cacheJSONObject);
        } catch (Exception e) {
            XGLog.e("write cache file error", e);
            ...
            if (fos != null) {
                try {
                    ...
                    XGLog.e("close resource error", e);
                }
            }
        }
    }
    ...
    public static JSONObject getInfo(Context context) {
        ...
        try {
            ...
            json.put(Constants.KEY_APPV, SystemInfo.getAppVersionCode(context));
    ...
    public static JSONObject getEventCountData() {
        ...
        try {
            ...
            XGLog.e("getEventCountData error", ex);
        }
    ...
    public static JSONObject getUplevelData(Context context, String roleLevel,
        ...
        try {
            ...
            XGLog.e("getUplevelData error", e);
        }
        return json;
    }
    ...
    public static JSONObject getConsumeData(Context context, String consumeId,
        ...
        try {
            ...
            XGLog.e("getConsumeData error", e);
        }
        return json;
    }
    ...
    public static JSONObject getErrorData(String errorMsg, boolean uncaught) {
        ...
        try {
            ...
            XGLog.e("getErrorData error : " + errorMsg, e);
        }
        return json;
    }
    ...
    public static JSONObject getErrorData(Context context, Throwable ex,
        ...
        try {
            ...
            XGLog.e("getErrorData error : " + ex.getMessage(), e);
        }
        return errorJson;
    }
    ...
    public static JSONObject getErrorData(Context context, String error,
        ...
        try {
            ...
            XGLog.e("getErrorData error : " + error, e);
        }
        return errorJson;
    }
    ...
    public static JSONObject getSDKErrorData(Context context,
        ...
        try {
            ...
            XGLog.e("getSDKErrorData error : " + errorInfo, e);
        }
        return errorJson;
    }
    ...
    public static JSONObject getCacheDatas(Context context) {
        ...
        try {
            ...
            try {
                ...
                XGLog.e("getCacheDatas close resouce error", e);
            }
        }
        return null;
    }
