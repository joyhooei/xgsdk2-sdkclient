...
public class XGDataAgent {
    ...
    public static void onResume(Context context) {
        try {
            if (context == null) {
                XGLog.e("unexpected null context");
                return;
            }
            open(context);
            ...
            XGLog.e("Exception occurred in .onResume(). ");
        }
    }
    ...
    public static void onPause(Context context) {
        try {
            ...
            XGLog.e("Exception occurred in .onRause(). ");
        }
    }
    ...
    public static void onError(Context context, Throwable ex) {
        try {
            ...
            XGLog.e("Exception occurred in .onError(). ", e);
        }
    }
    ...
    public static void onEvent(Context context, String eventId,
        ...
        try {
            ...
            XGLog.e("Exception occurred in .onEvent(). ", ex);
        }
    }
    ...
    private static void onEventCount(Context context, String eventId,
        ...
        try {
            ...
            XGLog.e("Exception occurred in .onEventCount(). ", ex);
        }
    }
    ...
    public static void onEventOnce(Context context, String eventId,
        ...
        try {
            ...
            XGLog.e("Exception occurred in .onEventOnce(). ", ex);
        }
    }
    ...
    public static void onEventInterval(Context context, String eventId,
        ...
        try {
            ...
            if (Math.abs(next - now) <= 5 * 60 * 1000 || last < 0) {
                ...
                XGLog.i("The interval time hasn't arrived.Next report time is "
                        + Constants.SDF.format(new Date(next)));
            }
        } catch (Exception ex) {
            XGLog.e("Exception occurred in .onEventInterval(). ", ex);
        }
    }
    ...
    private static void open(Context context, HashMap<String, String> other) {
        try {
            ...
            XGLog.e("Exception occurred in .open(). ", ex);
        }
    }
    ...
    private static void close(Context context, HashMap<String, String> other) {
        try {
            ...
            XGLog.e("Exception occurred in .close(). ", ex);
        }
    }
    ...
    public static void login(Context context, String roleName, int balance,
        ...
        try {
            ...
            XGLog.e("Exception occurred in .login(). ", ex);
        }
    }
    ...
    public static void logout(Context context, HashMap<String, String> other) {
        try {
            ...
            XGLog.e("Exception occurred in .logout(). ", ex);
        }
    }
    ...
    public static void consume(Context context, String consumeId, int goodsNum,
        ...
        try {
            ...
            XGLog.e("Exception occurred in .consume(). ", ex);
        }
    }
    ...
    public static void levelup(Context context, String roleLevel,
        ...
        try {
            ...
            XGLog.e("Exception occurred in .levelup(). ", ex);
        }
    }

    private static void order(Context context, String orderId,
    ...
    private static void order(Context context, String orderId,
            String billingId, float money, int type, String payWay,
            String payTime, String status, HashMap<String, String> other) {
        try {
            ...
            XGLog.e("Exception occurred in .order(). ", ex);
        }
    }

    public static void reward(Context context, String rewardId, int ingot,
            int type) {
        pay(context, rewardId, 0, ingot, type, PaymentType.OTHER, null);
    }
    ...
    private static void pay(Context context, String orderId, float money,
        ...
        try {
            if (TextUtils.isEmpty(orderId)) {
                XGLog.e("orderId can not be null!");
                return;
            }
            new ProcessThread(context, Constants.ACTION_GAME_PAY,
                    Common.getPayData(context, orderId, money, ingot, type,
                            payment), Common.getOtherData(other),
                    Constants.FLAG_GAME_ACTION).start();

        } catch (Exception ex) {
            XGLog.e("Exception occurred in .pay(). ", ex);
        }
    }

    public static void onExitOrKillProgress(Context context) {
        try {
            XGLog.w("onExitOrKillProgress");
            Common.storeCountEvent(context);
            Thread.sleep(100);
            close(context);
        } catch (Exception ex) {
            XGLog.e("Exception occurred in .onExitOrKillProgress(). ", ex);
        }
    }
