...
>>>>>>> 917b1a34a14e21b7f8381d551ff492e9b2b5f213
	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (map != null) {
					...
					if (!TextUtils.isEmpty(orderId)) {
						try {
							PayService.queryOrderStatus(OrdersActivity.this,
									orderId, new ICallback() {
		...
		new String[] { OrderUtils.KEY_ORDER_ID, OrderUtils.KEY_ORDER_DETAILS,
				OrderUtils.KEY_ORDER_TIME, OrderUtils.KEY_ORDER_STATUS },

		new int[] { RUtil.getId(getApplicationContext(), "xg_order_id"),
